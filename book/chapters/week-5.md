...
Keep the function's return separate from printing. Use a loop outside the function to display each test input and its result. Later, this function will be useful in helping you to decide which FASTA records can be analysed.
